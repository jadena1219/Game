...
export const FORGE = [
  { id: 'power', icon: '🗡️', name: 'Sharpen Blade', max: 8, baseCost: 12, costStep: 7,
    desc: (l) => `+${20 * l}% sword damage` },
  { id: 'armor', icon: '🛡️', name: 'Reinforce Armor', max: 8, baseCost: 13, costStep: 8,
    desc: (l) => `+${18 * l} max HP` },
  { id: 'whet', icon: '💨', name: 'Whetstone', max: 5, baseCost: 15, costStep: 9,
    desc: (l) => `+${Math.round((1 - Math.max(0.5, 1 - 0.1 * l)) * 100)}% swing speed` },
  { id: 'boots', icon: '👢', name: 'Swift Boots', max: 5, baseCost: 12, costStep: 7,
    desc: (l) => `+${8 * l}% move speed` },
  { id: 'reach', icon: '📐', name: 'Long Reach', max: 4, baseCost: 14, costStep: 8,
    desc: (l) => `+${14 * l}% reach & wider arc` },
  { id: 'wrath', icon: '😤', name: 'Wrath', max: 4, baseCost: 11, costStep: 7,
